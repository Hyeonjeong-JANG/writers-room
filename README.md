...
| AI         | FLock API (OpenAI-compatible)     |
...
│   └── story/               # 스토리/챕터 훅/스키마
├── lib/
│   ├── flock/               # FLock AI 클라이언트
│   ├── selanet/             # Selanet 트렌드 클라이언트
...
# Nansen 신뢰도 (없으면 mock 데이터)
NANSEN_X402_WALLET_KEY=

# Selanet 트렌드 (없으면 기본 키워드)
SELANET_API_KEY=
SELANET_API_BASE_URL=
...
| `nansen_wallet_cache` | Nansen 지갑 분석 캐시                         |
